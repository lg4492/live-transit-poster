...
class ShortestPathGetter:
            ...
            for connection_id in connections:
                ...
                if connection_id in self._station_shortest_times:
                    ...
                    if existing_time > earliest_arrival_at_connection:
                        ...
                        self._station_shortest_paths[connection_id] = self._station_shortest_paths[station.stop_id] + [connection_id]
    ...
    def get_shortest_paths(self, arrival_time):
        ...
        self._station_shortest_paths[self._home_station_id] = [self._home_station_id]
